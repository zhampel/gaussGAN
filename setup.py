...
NAME = 'gaussgan'
DESCRIPTION = 'Experiments on limitations of simulating Gaussian data with GANs',
MAINTAINER = 'Zigfried Hampel-Arias'
MAINTAINER_EMAIL = 'zhampel.github@gmail.com'
URL = 'https://github.com/zhampel/gaussGAN'
LICENSE = 'MIT'
...
about = {}
with io.open(os.path.join(here, 'gaussgan', '__version__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
